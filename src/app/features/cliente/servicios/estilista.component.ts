    ...
    <div class="bg-white min-h-screen">
      <div class="px-8 py-8">
        ...
        <div class="grid grid-cols-3 gap-6 max-w-4xl">
          <button routerLink="/cliente/servicios/horario" class="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition hover:border-pink-600">
            <div class="w-24 h-24 bg-gradient-to-br from-pink-300 to-pink-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white">
          ...
          <button routerLink="/cliente/servicios/horario" class="bg-white border border-gray-200 rounded-lg p-6 text-center hover:shadow-lg transition hover:border-pink-600">
            <div class="w-24 h-24 bg-gradient-to-br from-rose-300 to-rose-500 rounded-full mx-auto mb-4 flex items-center justify-center text-white">
              <span class="material-symbols-outlined text-5xl">person</span>
            </div>
        ...
        <div class="mt-8 max-w-4xl">
          <button class="w-full border-2 border-dashed border-gray-300 text-gray-600 rounded-lg py-4 font-semibold hover:border-pink-600 hover:text-pink-600 transition">
