...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'agenda-general',          loadComponent: () => import('./features/admin/agenda-general.component').then(m => m.AgendaGeneralComponent) },
      { path: 'empleados',               loadComponent: () => import('./features/admin/empleados.component').then(m => m.EmpleadosComponent) },
      { path: 'servicios',               loadComponent: () => import('./features/admin/servicios.component').then(m => m.ServiciosComponent) },
      { path: 'clientes',                loadComponent: () => import('./features/admin/clientes.component').then(m => m.ClientesComponent) },
      { path: 'solicitudes-especiales',  loadComponent: () => import('./features/admin/solicitudes-especiales.component').then(m => m.SolicitudesEspecialesComponent) },
      { path: 'reportes-clientes',       loadComponent: () => import('./features/admin/reportes-clientes.component').then(m => m.ReportesClientesComponent) },
      { path: 'reportes-estadisticas',   loadComponent: () => import('./features/admin/reportes-estadisticas.component').then(m => m.ReportesEstadisticasComponent) },
      { path: 'configuracion',           loadComponent: () => import('./features/admin/configuracion.component').then(m => m.ConfiguracionComponent) },
    ]
  },
